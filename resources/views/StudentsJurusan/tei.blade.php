...
<div class="jumbotron jumbotron-fluid">
  <div class="container">
    <h1 class="display-4">Teknik Elektronik Industri</h1>
    <center><img src="{{ asset('/img/tei.jpg')}}" class="my-4 rounded-circle shadow" height="150" widht="150"> </center>
    <p class="lead">Ini adalah halaman untuk setiap data Students yang memiliki jurusan Teknik Elektronik Industri.</p>
...
<div class="row">
    <div class="col">
        ...
        <form method="POST" class="my-3" action="/search/jurusan/{{'TEI'}}">
            @method('get')
            @csrf
